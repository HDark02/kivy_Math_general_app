...
source.include_exts = py,png,jpg,kv,atlas,txt,ico,jpeg,gif
...
requirements = python3,kivy==2.1.0, kivymd==1.1.1, sdl2_ttf==2.0.15, pillow, git+https://github.com/sympy/sympy.git
